import type { TextStats, SemanticPhrase, StopWord, TextAnalysisResult, ToxicityLevel } from '../types';

// Список стоп-слов
const STOP_WORDS = new Set([
  // Союзы
  'и', 'а', 'но', 'или', 'да', 'либо', 'то', 'не то', 'затем', 'потом', 'однако', 'зато', 'также',
  // Местоимения
  'я', 'ты', 'он', 'она', 'оно', 'мы', 'вы', 'они', 'мой', 'твой', 'его', 'её', 'наш', 'ваш', 'их',
  'себя', 'тебя', 'меня', 'нас', 'вас', 'этот', 'тот', 'такой', 'который', 'какой', 'чей',
  // Предлоги
  'в', 'на', 'с', 'к', 'по', 'за', 'от', 'до', 'для', 'при', 'через', 'между', 'над', 'под', 'перед',
  'после', 'без', 'против', 'вместо', 'кроме', 'около', 'возле', 'среди', 'вокруг', 'вдоль',
  // Частицы
  'не', 'ни', 'же', 'ли', 'бы', 'даже', 'уже', 'ещё', 'только', 'лишь', 'хотя', 'пусть', 'пускай',
  // Междометия
  'ах', 'ох', 'эх', 'ой', 'ай', 'увы', 'браво', 'спасибо', 'пожалуйста', 'извините', 'простите',
  // Числительные
  'один', 'два', 'три', 'четыре', 'пять', 'шесть', 'семь', 'восемь', 'девять', 'десять',
  'первый', 'второй', 'третий', 'последний', 'много', 'мало', 'несколько',
  // Вводные слова
  'например', 'допустим', 'предположим', 'честно говоря', 'кстати', 'между прочим', 'во-первых',
  'во-вторых', 'в-третьих', 'наконец', 'итак', 'таким образом', 'следовательно',
  // Отдельные буквы
  'а', 'б', 'в', 'г', 'д', 'е', 'ё', 'ж', 'з', 'и', 'й', 'к', 'л', 'м', 'н', 'о', 'п', 'р', 'с', 'т', 'у', 'ф', 'х', 'ц', 'ч', 'ш', 'щ', 'ъ', 'ы', 'ь', 'э', 'ю', 'я',
  // Служебные слова
  'быть', 'есть', 'был', 'была', 'было', 'были', 'будет', 'будут', 'это', 'то', 'что', 'как', 'где', 'когда', 'почему', 'зачем'
]);
